...
export default function Cocina() {
  ...
  return (
    <div className="flex flex-col" style={{ height: '100vh', backgroundColor: 'var(--bg-color)', overflowY: 'auto', overflowX: 'hidden' }}>
      ...
      {confirmDispatch && (
        <div className="modal animate-fade-in" style={{ display: 'flex', position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(8px)', zIndex: 1000, alignItems: 'center', justifyContent: 'center' }}>
